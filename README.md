# The Big Bang Theory Dialogue Predictor
...
1. **Open the Application:** Navigate to the hosted frontend URL.
2. **Enter Text:** In the main input box, type a sentence, quote, or phrase you want to test.
3. **Submit:** Click the "Post" button.
4. **View Result:** The application will process your text. A "reply" will appear in the feed from the character the model predicts would say that line, complete with their name and profile picture.
